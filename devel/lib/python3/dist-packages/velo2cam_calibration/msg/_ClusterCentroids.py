...
"""autogenerated by genpy from velo2cam_calibration/ClusterCentroids.msg. Do not edit."""
import codecs
import sys
...
class ClusterCentroids(genpy.Message):
  _md5sum = "9a2787f0622955b34b1f08821ba3ada1"
  _type = "velo2cam_calibration/ClusterCentroids"
...
"""
  __slots__ = ['header','cluster_iterations','total_iterations','cloud']
  _slot_types = ['std_msgs/Header','uint32','uint32','sensor_msgs/PointCloud2']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,cluster_iterations,total_iterations,cloud
    ...
    """
    if args or kwds:
      super(ClusterCentroids, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.cluster_iterations is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_5I().pack(_x.cluster_iterations, _x.total_iterations, _x.cloud.header.seq, _x.cloud.header.stamp.secs, _x.cloud.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.cluster_iterations, _x.total_iterations, _x.cloud.header.seq, _x.cloud.header.stamp.secs, _x.cloud.header.stamp.nsecs,) = _get_struct_5I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
